...
class CGENFFTopologyLoader:
    """Class for loading topology definition to the heterogen residues where 
    the topology and parameters are generated by cgenff."""
    def __init__(self, cgenff_path=None):
    ...
    def _get_cgenff_topology(self, input_mol2_block):
        ...
        self._raw_data_blocks.append(toppar_block)
    ...
    def generate(self, lig_res):
        ...
        self._get_cgenff_topology(mol2_block)
